...
local function ONEE_fake_script() -- TextButton.LocalScript 
    ...
    local button = -- your button UI element, get it appropriately
        ...
        local function executeScript()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/rileybeerblx2/Axoim-Mobile-Version/main/mobileandpcversion.lua", true))()
        end
...
coroutine.wrap(ONEE_fake_script)()
local function JYSWB_fake_script() -- TextButton.LocalScript 
    local script = Instance.new('LocalScript', TextButton)
...
coroutine.wrap(JYSWB_fake_script)()
